...
public class AutonLeft extends Command{
	...
	public AutonLeft(double forwardVel, double turnVelL, double turnVelR, double leftTargetInches,  double rightTargetInches) {
	...
	protected void execute() {
		Robot.autondrive.executeL(forwardVel1, turnVelL1, turnVelR1, leftTargetInches1, rightTargetInches1);
	}
	@Override
